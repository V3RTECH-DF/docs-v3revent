...
{: .note }
> **Controles de tamanho de texto (acessibilidade).** Ainda na aba **Aparência**, a opção **"Mostrar controles de tamanho de texto na página do evento"** exibe **A− / A / A+** numa **caixinha discreta no canto superior direito do topo do evento (hero)** (layout "Página do Plugin"), para o visitante aumentar ou diminuir o conteúdo. Vem **ligada por padrão**; desmarque para ocultá-la neste evento.
