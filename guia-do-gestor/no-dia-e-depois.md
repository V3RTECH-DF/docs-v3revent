...
O check-in é **idempotente** (marcar de novo não muda o horário) e **reversível** (dá para desfazer). Veja **[Check-in](/modulos/checkin/)**.
...
Na tela **[Relatórios](/modulos/relatorios/)**, a coluna **Presença** mostra quem já entrou (com horário) e quem falta, com filtro de presentes/ausentes e contador. Você pode marcar ou desmarcar presença manualmente — útil para quem esqueceu a credencial.
